...
export const CalibrationScreen: React.FC<CalibrationScreenProps> = ({ onNavigate }) => {
  ...
  return (
    <div
      ...
      className="relative w-full h-full flex flex-col items-center justify-between p-6 sm:p-10 z-30 select-none"
    >
      {/* Top Header */}
      <div className="w-full max-w-xl flex items-center justify-between">
        ...
        <span className="font-arcade text-xs text-emerald-400 tracking-wider">
          STEP 2 OF 2
        </span>
      </div>

      {/* Center Calibration Content */}
      <div className="flex flex-col items-center text-center my-auto max-w-lg">
        ...
        {/* Circular Progress Indicator with Crosshair */}
          ...
          <div className="absolute inset-8 rounded-full border border-slate-700/60 flex flex-col items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
            ...
            {isComplete ? (
              ...
              >
                ...
                <span className="font-arcade text-base text-emerald-300 tracking-wider">
                  COMPLETE!
                </span>
              </motion.div>
            ) : (
        ...
        {isComplete ? (
          ...
          >
            <div className="font-arcade text-2xl sm:text-3xl text-emerald-400 arcade-text-shadow">
          ...
          <div className="mt-8 text-sm text-slate-400">
            Zeroing accelerometer & gyroscope sensors on your device...
          </div>
        )}
      </div>
