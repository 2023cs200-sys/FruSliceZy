...
export const PauseOverlay = ({ onResume, onRestart, onSettings, onMainMenu }) => {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        <div className="w-full flex flex-col gap-3.5 z-10">
          <button
            id="pause-resume-btn"
            onClick={() => { sound.playButton(); onResume(); }}
          ...
          <button
            ...
            onClick={() => { sound.playButton(); onSettings(); }}
          ...
          <button
            ...
            onClick={() => { sound.playButton(); onMainMenu(); }}
