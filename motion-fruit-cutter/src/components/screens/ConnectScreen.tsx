...
import { ControllerConfig, ScreenState } from '../../types';
import { sound } from '../../utils/sound';

interface ConnectScreenProps {
  controller: ControllerConfig;
  onUpdateController: (updated: Partial<ControllerConfig>) => void;
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 my-auto items-center">
        {/* Left Column: Connection Form & Instructions */}
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="text-slate-300 text-sm sm:text-base mt-2 font-medium">
              Connect your phone to control the sword.
            </p>
          </div>
        ...
        {/* Right Column: Visual Smartphone / Motion Controller Illustration */}
        <div className="flex flex-col items-center justify-center bg-slate-900/70 backdrop-blur-md p-8 rounded-3xl border border-slate-700/80 shadow-2xl relative">
          ...
          >
            ...
            <div className="w-full flex-1 my-2 rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-800 p-3 flex flex-col items-center justify-between text-center overflow-hidden relative">
              {/* Animated motion wave on screen */}
              ...
              {/* Real-time Gyro telemetry display */}
              ...
              <div className="z-10 mb-1">
                <span className="text-[9px] text-slate-500">SWIPE PHONE TO SLASH</span>
              </div>
            </div>
      ...
      <div className="text-center text-xs text-slate-500 z-10">
        React Native Expo app connects via WebSocket to Ursina Python game server.
      </div>
    </div>
  );
};
