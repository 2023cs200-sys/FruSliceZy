...
export const HowToPlayScreen: React.FC<HowToPlayScreenProps> = ({ onNavigate }) => {
  const steps = [
    {
      num: '01',
      title: 'CONNECT',
      desc: 'Connect your smartphone to the game.',
      icon: Smartphone,
    ...
    },
    {
      num: '02',
      title: 'CALIBRATE',
      desc: 'Hold your phone still during calibration.',
      icon: Compass,
    ...
    },
    {
      num: '03',
      title: 'SLICE',
      desc: 'Move your phone like a sword to slice fruits.',
      icon: Zap,
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl flex items-center justify-between">
        ...
        <h1 className="font-arcade text-3xl sm:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-orange-400 to-red-500 arcade-text-shadow">
          HOW TO PLAY
        </h1>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <span className="font-arcade text-3xl sm:text-4xl text-slate-400/50">
                  {step.num}
                </span>
              ...
              <div className="my-2 flex items-center justify-center">
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center shadow-lg border border-white/20`}
                >
              ...
              <div className="mt-4 text-center">
                <h3 className="font-arcade text-xl sm:text-2xl text-white tracking-wider mb-1">
                  {step.title}
                </h3>
      ...
      {/* Rules Banner (Arcade Multiplier Scoring) */}
      <motion.div
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-arcade text-base sm:text-lg text-amber-300 tracking-wider">
              MORE FRUITS = MORE SCORE
            </div>
            <div className="text-xs text-slate-400">
              Each fruit grants 10-25 base points
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-arcade text-base sm:text-lg text-orange-400 tracking-wider">
              CONSECUTIVE CUTS = COMBO
            </div>
            <div className="text-xs text-slate-400">
              Chain slices within 400ms for multiplier
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-arcade text-base sm:text-lg text-yellow-300 tracking-wider">
              HIGH COMBO = HIGH SCORE
            </div>
            <div className="text-xs text-slate-400">
              Multiply points up to x10 or higher!
            </div>
          </div>
        </div>
      </motion.div>
