...
- The laptop is running the game.
- The smartphone and laptop use the same Wi-Fi network.
...
3. Enter the configured port if required.
4. Press Connect.
...
Move the phone quickly in the desired direction to create a slash.
